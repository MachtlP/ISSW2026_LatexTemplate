...
%  To meet accessibility Requirements this is a completly new template. The .cls file is therefore completly new and within the .tex file you wil find some slight adaptions of how to handle figuresa and tables 
% Cheers Machtl 
...
All ISSW presenters - both oral and poster pre-
senters - are required to submit a paper (maximum
8 pages) that describes their presentation topic in
more detail for publication in the ISSW 2026 pro-
ceedings. At this ISSW, the conference proceedings
will only be published electronically.
...
List all bibliographic references at the end of the paper in alphabetical order by first author. When referring to them in the text, use the \verb|\cite{}| command with the citation key, e.g., \citet{McClung2006}. Use referencing style as used in \href{https://www.natural-hazards-and-earth-system-sciences.net/submission.html#references}{Natural Hazards and Earth System Sciences} (see sample references at the end of these instructions) \citep{McClung2006}.
...
\begin{itemize}
 ...
 \item Tag your PDF for accessibility. This can be done by adding the \verb|\usepackage[articletitle=true, pdfa=true]{hyperref}| package and compiling with \verb|pdflatex|. You can also run Adobe Acrobat Pro's "Autotag Document" feature after compiling to add accessibility tags.
\end{itemize}
