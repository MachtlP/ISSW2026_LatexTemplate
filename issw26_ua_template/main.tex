...
List all bibliographic references at the end of the paper in alphabetical order by first author. When referring to them in the text, use the \verb|\textcite{}| command with the citation key, e.g., \textcite{McClung2006}. Use referencing style as used in \href{https://www.natural-hazards-and-earth-system-sciences.net/submission.html}%
{\textit{Natural Hazards and Earth System Sciences}}
(see sample references at the end of these instructions) \parencite{McClung2006}.
