...
%  To meet accessibility requirements this is a completely new template. The .cls file is therefore new and in the .tex file you will find some slight adaptions of how to handle figures and tables. 
%Most importantly, LuaLaTeX is required to produce accessible, tagged PDF/UA documents.
%The tagging process is computationally intensive, so Overleaf Premium is recommended. The free version may time out during compilation.
% Cheers Machtl 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%               * INSTRUCTIONS *
